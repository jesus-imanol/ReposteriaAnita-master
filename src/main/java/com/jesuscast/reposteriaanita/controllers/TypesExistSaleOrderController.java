...
public class TypesExistSaleOrderController {
    ...
    void onClickOrdersHome(MouseEvent event) {
        AppReposteria.newStage("existe-pedido-domicilio-view","Existe pedido en domicilio");
    }

    @FXML
    void onClickOrdersInPremises(MouseEvent event) {
        AppReposteria.newStage("existe-pedido-view","Existe el pedido local");
    }
